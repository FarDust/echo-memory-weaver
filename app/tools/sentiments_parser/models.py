...
class AlivenessJoy(BaseModel):
    ...
    emotions: list[Literal[
        ...
        "Playful", "Radiant", "Refreshed", "Rejuvenated", "Renewed",
        "Satisfied", "Thrilled", "Vibrant"
    ]] = Field(
        description="List of emotions associated with joy and aliveness."
    )
...
class Angry(BaseModel):
    ...
    emotions: list[Literal[
        ...
        "Impatient", "Irritated", "Irate", "Moody", "On edge", 
        "Outraged", "Pissed", "Resentful", "Upset", "Vindictive"
    ]] = Field(
        description="List of emotions associated with anger or irritation."
    )
...
class Courageous(BaseModel):
    ...
    emotions: list[Literal[
        ...
        description="List of emotions associated with courage and confidence."
    )
...
class Connected(BaseModel):
    ...
    emotions: list[Literal[
        ...
        "Interested", "Intrigued", "Involved", "Stimulated"
    ]] = Field(
        description="List of emotions associated with connectedness and empathy."
    )
...
class DespairSad(BaseModel):
    ...
    emotions: list[Literal[
        ...
        "Unhappy", "Upset", "Weary", "Yearning"
    ]] = Field(
        description="List of emotions associated with sadness or despair."
    )
...
class DisconnectedNumb(BaseModel):
    ...
    emotions: list[Literal[
        ...
        description="List of emotions associated with numbness or disconnection."
    )
...
class EmbarrassedShame(BaseModel):
    ...
    emotions: list[Literal[
        ...
        description="List of emotions associated with shame or embarrassment."
    )
...
class Fear(BaseModel):
    ...
    emotions: list[Literal[
        ...
        description="List of emotions associated with fear or anxiety."
    )
...
class Grateful(BaseModel):
    ...
    emotions: list[Literal[
        ...
        description="List of emotions associated with gratitude or appreciation."
    )
...
class Tender(BaseModel):
    ...
    emotions: list[Literal[
        ...
        description="List of emotions associated with tenderness and warmth."
    )
...
class Stressed(BaseModel):
    ...
    emotions: list[Literal[
        ...
        description="List of emotions associated with stress or fatigue."
    )
...
SentimentCategoryType = Union[
    AcceptingOpen, AlivenessJoy, Angry, Courageous, Connected, DespairSad,
    DisconnectedNumb, EmbarrassedShame, Fear, Fragile, Grateful, Guilt,
    Hopeful, Powerless, Tender, Stressed, UnsettledDoubt
]

AnalysisModels = Literal[
    "llm"
]
